###
WikimokuBTCE_Lite v0.1 - Thanasis / BTCorbust / et al - with Liteguy settings
...
class Init
  @init_context: (context) ->
    ...
    context.ichi_bull = new Ichimoku(9, 26, 26, 26, 26)
    context.ichi_bear = new Ichimoku(9, 26, 26, 26, 26)
    context.config_bull = new Config(
      1, -2, -1, 2, #lo/lc/so/sc
      0, 0, #kumo_pad-below/above
      0, 0, #chikou_span-low/high
      0.025, 0.20, #sar-accel/max
      20, 20, #aroon-period/threshold
      9, 12, 26, 0, 1, #macd-fast/slow/sig/low/high
      30, 50, 50 #rsi-period/low/high
    )
    ...
    context.bull_market_threshold = 0.00
    context.bear_market_threshold = 0.00
    context.market_short = 10
