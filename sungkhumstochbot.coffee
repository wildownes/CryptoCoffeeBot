###########################################################  
#                                                         #
# Sungkhum StochRSI/MACD Bot 1.0                          #
...
######    buy or sell Strategy #########
    ...
    else if context.selltrue and (context.prevmacd[2] - macd.macd) < 0.5 and context.sellcount < 10 and stochrsi.D > stochrsi.K     ## you must write here your own condition to sell
